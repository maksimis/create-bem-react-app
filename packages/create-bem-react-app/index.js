...
<<<<<<< HEAD:packages/create-react-app/index.js
...
function createApp(name, verbose, version, template) {
  ...
  console.log(
    'Creating a new BEM React app in ' + chalk.green(root) + '.'
  );
  console.log();
  ...
  console.log('Installing ' + chalk.cyan('bem-react-scripts') + '...');
  console.log();
...
function getInstallPackage(version) {
  var packageToInstall = 'bem-react-scripts';
...
function checkAppName(appName) {
  ...
  var devDependencies = ['bem-react-scripts'];
...
>>>>>>> ca7fbfb... dev env only:packages/create-bem-react-app/index.js
